...
Previous configuration registers a Micronaut app with Eureka with minimal configuration. Discover a more complete list of Configuration options at https://docs.micronaut.io/snapshot/api/io/micronaut/discovery/eureka/EurekaConfiguration.html[EurekaConfiguration].
